...
![](https://farm6.staticflickr.com/5744/20578210488_c5016e6191_b.jpg =600x)
 ...
 <iframe src="https://player.vimeo.com/video/136769465?title=0&byline=0&portrait=0" width="600" height="338" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
...
```[Interactive part: You can turn the knob by dragging the mouse to change the frequency.]``` 
...
-  [Binary Logic Worksheet](https://farm8.staticflickr.com/7230/13984125176_91ccb45b3a_o.jpg)
-  Also [how to make Adder, Memory](https://farm8.staticflickr.com/7251/14007688534_adb24c48f8_k.jpg) with the logic gates. 
-  And out of NAND logic gates, you can make a 1 bit computer! [Here](https://github.com/tchoi8/handmadecomputer/tree/master/Binary/NAND)
